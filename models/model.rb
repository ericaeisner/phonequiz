...
#do a calculation
#use conditionals to make a choice or comparison
#there will probably be a method 
...
#Dont put "puts" in our method

#def mehtod(parameter)
